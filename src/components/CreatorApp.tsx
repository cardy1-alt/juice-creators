    ...
    <div className="px-4 md:px-6 lg:px-8 pb-8 pt-4">
      ...
      <div className="bg-white border border-[rgba(42,32,24,0.08)] rounded-[12px] p-8 text-center">
        ...
        {import.meta.env.VITE_WHATSAPP_ENABLED === 'true' ? (
          ...
          <div className="inline-flex items-center gap-2 px-5 py-3 rounded-[6px] bg-[#F6F3EE] text-[var(--ink-60)] font-medium text-[13px] min-h-[44px]">
            Community launching soon — stay tuned
          </div>
        )}
      </div>
    </div>
