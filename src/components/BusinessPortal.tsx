  ...
  return (
    <div>
      ...
      {scanning && (
        <button
          onClick={stopScanner}
          className="w-full mt-2 py-2 rounded-full font-semibold text-sm bg-[#F7F7F7] text-[#222222] hover:bg-[#ececec] transition-all"
        >
          Stop Scanner
        </button>
      )}
                ...
                <form onSubmit={handleCreateOffer} className="bg-white rounded-[20px] p-6 border border-[rgba(34,34,34,0.1)] shadow-[0_1px_4px_rgba(34,34,34,0.06),0_4px_16px_rgba(34,34,34,0.04)] space-y-4">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1.5">
                      <label className="text-sm font-semibold text-[#222222]">Limit monthly claims?</label>
                      <button
                        type="button"
                        onClick={() => {
