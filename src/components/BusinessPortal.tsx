                    ...
                    <tbody className="divide-y divide-gray-50">
                      {claims.map((claim) => (
                        <tr key={claim.id} className="hover:bg-gray-50/50 transition-colors">
                          ...
                          <td className="px-5 py-3.5 whitespace-nowrap text-sm text-gray-500">{claim.creators.instagram_handle}</td>
                          <td className="px-5 py-3.5 whitespace-nowrap"><span className="text-xs font-mono font-bold px-2 py-0.5 rounded bg-[#1a1025] text-white">{claim.creators.code}</span></td>
                          <td className="px-5 py-3.5 whitespace-nowrap text-sm text-gray-500">{new Date(claim.claimed_at).toLocaleDateString()}</td>
                          <td className="px-5 py-3.5 whitespace-nowrap"><StatusPill status={claim.status} /></td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
