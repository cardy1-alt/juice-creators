  ...
  return (
    <div ref={ref} className={`relative ${className}`}>
      ...
      {open && (
        <div
          ref={listRef}
          className="absolute z-50 w-full mt-1 bg-white rounded-[12px] border border-[rgba(42,32,24,0.08)] overflow-hidden overflow-y-auto"
          style={{ maxHeight: 240, boxShadow: '0 4px 16px rgba(42,32,24,0.10)' }}
        >
          {options.map((opt, i) => {
