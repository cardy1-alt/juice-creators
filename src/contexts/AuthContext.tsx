...
const DEMO_PROFILES: Record<string, { role: UserRole; profile: any }> = {
  creator: {
    ...
    profile: {
      ...
      bio: 'Local foodie & wellness lover sharing the best of Suffolk',
  ...
  business: {
    ...
    profile: {
      ...
      region: 'Suffolk',
      address: '42 Abbeygate Street, Bury St Edmunds',
      bio: 'Specialty coffee & brunch in the heart of Bury. Single-origin beans, house-made pastries, and the best flat white in Suffolk.',
      instagram_handle: 'midgarcoffee',
      logo_url: 'https://images.unsplash.com/photo-1442512595331-e89e73853f31?w=200&h=200&fit=crop',
      approved: true,
      onboarding_complete: true,
      is_live: true,
      created_at: new Date().toISOString(),
